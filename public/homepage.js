document.addEventListener('DOMContentLoaded', function() {
    ...
    function getTeamLogo(teamName) {
        // Convert API team name to your custom logo key
        const apiToCustomTeamNames = {
        ...
        return teamLogos[apiToCustomTeamNames[teamName]] || '/defaultLogo.png'; // Default logo if not found
    }
